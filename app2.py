...
st.sidebar.subheader("About Mulbert Text-to-Music Model")
...
st.components.v1.iframe("https://shad0ws-imagetomusic.hf.space", width=1175, height=650, scrolling=False)